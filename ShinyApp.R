...
SCI <- read.csv('/Users/jkuypers/SCI_ALL(Melted)_new.csv',header=TRUE, sep=",")

#Measures divided into columns - used in Table
SCI_Table <- read.csv('/Users/jkuypers/SCI_ALL(Melted).csv',header=TRUE, sep=",")


#world shape file
WorldMap <- readOGR('/Users/jkuypers/Documents/NOVA_IMS/DataVisualization/GroupProjectFiles/TM_WORLD_BORDERS-0.3/TM_WORLD_BORDERS-0.3.shp')
